...
Formation    : Orange Digital Center Sénégal - AWS re/Start
Passion      : Sécuriser, automatiser, innover ☁️🔒
```

> _"Ingénieur réseaux et sécurité passionné par le Cloud et les pratiques DevOps"_

Spécialisé en infrastructures réseau, cybersécurité et architectures cloud AWS. Actuellement en formation **AWS re/Start** à l'Orange Digital Center, je combine expertise en sécurité réseau et compétences Cloud modernes (AWS, Docker/Kubernetes, Terraform, Jenkins).
...
|---------|---------------|---------|
| 🔶 2025 – 2026 | **Orange Digital Center** — Sénégal | Formation AWS re/Start (Cloud & DevOps) |
