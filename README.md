...
**Sécurité** : Cisco ASA, pfSense, IPSec, SSL VPN, Snort (IDS/IPS), Wireshark, Nmap, Nessus, Metasploit, ISO 27001, ANSSI  
**Réseaux** : TCP/IP, VLAN, DHCP, DNS, RIP, OSPF, BGP, EIGRP, MPLS, NAT, QoS, IPv4/IPv6
...
- ✅ EC2 Auto Scaling + Load Balancer + VPC multi-tiers sécurisé
- ✅ Pipeline CI/CD : Jenkins → SonarQube → Tests automatisés → Déploiement
- ✅ Conteneurisation Docker, IaC Terraform, Monitoring CloudWatch/SNS
- 🛠️ **Tech** : AWS (EC2, S3, VPC, RDS), React.js, Node.js, MongoDB, Docker, Jenkins, Terraform

### ☸️ [Pipeline CI/CD avec Orchestration Kubernetes](https://github.com/siakha-kaba/k8s-cicd-pipeline)
Architecture microservices sur cluster Kubernetes avec pipeline GitOps complet
- ✅ Pipeline Git → Jenkins → SonarQube → Docker Registry → Kubernetes
- ✅ Déploiement Helm Charts, stratégies Rolling Update/Blue-Green
- ✅ Monitoring Prometheus/Grafana avec alerting automatique
- 🛠️ **Tech** : Kubernetes, Docker, Jenkins, Helm, Prometheus, Grafana, Terraform, SonarQube

### 🔐 [Architecture Cloud Sécurisée Multi-Tiers AWS](https://github.com/siakha-kaba/aws-secure-architecture)
Infrastructure AWS hautement disponible et sécurisée avec IaC
- ✅ VPC multi-tiers (public/private/database), déploiement Multi-AZ
- ✅ Sécurité : IAM granulaire, Security Groups, WAF, VPN IPSec site-to-site
- ✅ Snapshots automatisés, CloudWatch/CloudTrail, alertes SNS
- 🛠️ **Tech** : AWS (VPC, EC2, ELB, IAM, WAF), Terraform, VPN IPSec

### 🛡️ [Audit Sécurité Infrastructure Réseau](https://github.com/siakha-kaba/network-security-audit)
Audit de sécurité complet d'une infrastructure réseau (50 postes)
- ✅ Scan Nessus/OpenVAS, pentest Nmap/Metasploit → 15 CVE critiques identifiées
- ✅ Mesures correctives : hardening, segmentation VLAN, pare-feu Cisco ASA
- ✅ Rapport d'audit 30 pages conforme ANSSI
- 🛠️ **Tech** : Kali Linux, Nessus, Wireshark, Nmap, Metasploit, Cisco ASA

### 🔒 [Architecture Sécurité VPN IPSec & IDS](https://github.com/siakha-kaba/vpn-ipsec-ids)
Interconnexion sécurisée de sites distants avec détection d'intrusion
- ✅ VPN IPSec site-to-site, pare-feux Cisco ASA/pfSense
...
- **Master Réseaux, Sécurité et Systèmes Distribués** | Université Gaston Berger | *2021-2023*
- **Technicien Support Réseau** | Simplon Sénégal | *08/2024-10/2024*

### 🏆 Certifications
- 🎯 **AWS Cloud Practitioner** *(en cours)*
- ✅ **AWS re/Start Graduate** - Orange Digital Center
